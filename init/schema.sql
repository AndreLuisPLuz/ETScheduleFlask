...
CREATE TABLE instructor_skills (
    ...
    value INT NOT NULL,
    CONSTRAINT FK_instructor_skills_instructor_id FOREIGN KEY (instructor_id) REFERENCES profiles(id)
);
...
CREATE TABLE student_competences (
    ...
    CONSTRAINT FK_student_competences_student_id FOREIGN KEY (student_id) REFERENCES profiles(id)
);
...
CREATE TABLE students_avaliation (
    ...
    CONSTRAINT FK_students_avaliation_student_id FOREIGN KEY (student_id) REFERENCES profiles(id)
);
